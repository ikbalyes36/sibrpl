            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                 <div class="row">
                    <div class="col-lg-12">
                       ...
                       <center>View Data Barang</center>  
                        </h1>
                        <p>
                ...
                <div class="box-body">
                  <table id="example1" class="table table-striped">
                    ...
                    $Lihat="SELECT id_barang, nama, kepemilikan, kondisibaik,kondisiburuk, keterangan, date FROM tabeldatabarang ORDER BY date desc";
                ...
                ?>
                                                ...
                                                <td><?=$id_barang?><div align="center"></div></td>
                                                ...
                                                <td><a href="editbarang.php?id_barang=<?php echo $hasil['id_barang'] ?>"align center> <button type="button" class="btn btn-sm btn-danger" align="center"> Evaluasi Barang</button</a></td>    <!--membuat link ke file dan hapus.php-->
                                            </tr>
