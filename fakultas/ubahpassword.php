                       ...
                       <center>Ubah Password</center>  
                        ...
                        <p>
                            ...
                            <div class="panel-body">
                                  <div class="container">
                                          <form role="form" method="POST" action="ubahpasswordact.php">
                                            <div class="form-group">
                                              ...
                                              <br>
												<?php
                                                        ...
                                                        $select = mysql_query( "SELECT usernamefak FROM adminfakultas where usernamefak='$test'");
														$data = mysql_fetch_array($select);
												?>
                                              <input class="form-control" readonly="readonly" name="usernamefak" type="text" placeholder="" value="<?php echo $data['usernamefak'] ?>">
                                              <br>
                                              <label >PASSWORD LAMA </label>
                                              <br>
                                              <input class="form-control" name="passlama" type="PASSWORD" >
                                              <br>
                                              <label> PASSWORD BARU </label>
                                              <input class="form-control" name="passbaru" type="PASSWORD" >
                                              <br>
                                              <br>
