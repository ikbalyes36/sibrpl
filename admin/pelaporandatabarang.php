...
Fakultas Teknik Elektro, Jl. Telekomunikasi Terusan Buahbatu DayeuhKolot, Bandung, Indonesia 40257
                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <?php
                                        include "config.php";
                                        $caunt=mysql_query("SELECT * FROM mutasibarang");
                                        $num_rows=mysql_num_rows($caunt);
                                        ?>
                                        <div class="huge"><?=$num_rows?></div>
                        ...
                        <div class="panel panel-yellow">
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <?php
                                     include "config.php";
                                        $caunt=mysql_query("SELECT * FROM barang ");
                                        $test2=mysql_num_rows($caunt);
                                        ?>
                                        <div class="huge"><?=$test2?></div>
                                        <div>Total Data Barang!</div>
                                    </div>
                                </div>
                            </div>
                            <a href="searchdatabarang.php">
                                <div class="panel-footer">
                                    <span class="pull-left">View Details</span>
                                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                    <div class="clearfix"></div>
    ...
    foreach ($data_series as $key=>$val) {
        $sql = 'SELECT COUNT(*) AS result FROM barang';
