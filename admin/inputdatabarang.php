                       ...
                       <center>Input Data Barang</center>  
                        ...
                        <p>
                            ...
                            <div class="panel-body">
                                  <div class="container">
                                          <form role="form" method="POST" action="inputdatabarangact.php">
                                            <div class="form-group">
                                              <label >ID Barang</label>
                                              <br>
                                              <input class="form-control" name="idbarang" type="text" placeholder="Format : DBRXXXX">
                                              <br>
                                              ...
                                              <label >Jumlah</label>
                                              <br>
                                              <input class="form-control" name="jumlah" type="text" placeholder="Banyaknya Jumlah">
                                              <br>
