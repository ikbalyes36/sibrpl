    ...
    <![endif]-->
       <script>
        function myFunctionx(){
            var idtanah = document.getElementById("tanah").value;
            window.location.assign("?idtanah="+idtanah);
        }
                        ...
                        <h1 class="page-header">
                         ...
                         <p align="center">
							<a id="atitle">UNIT LOGISTIK TELKOM UNIVERSITY</a>
                                ...
                                <center>Mutasi Data Tanah</center>  
                        </h1>
                        <p>
                            ...
                            <div class="panel-body">
                                  <div class="container">
                                          <form role="form" method="POST" action="mutasidatatanahact.php">
                                              <label >ID Barang</label>
                                              <br>
                                              <select class="form-control" name="idtanah" id="tanah"  onchange="myFunctionx()" >
                                                    <option>--Pilih ID tanah--</option>
                                                    <?php
                                                        include "config.php";
                                                        $select = mysql_query( "SELECT idtanah FROM tanah ");
                                                        while($data = mysql_fetch_array($select)){
                                                                ?>
                                                     <option value="<?php echo $data['idtanah'] ?>"><?php echo $data['idtanah'] ?></option>
                                                            <?php
                                                        }
                                                    ?>
                                                </select>
                                                ...
                                                <?php
                                                        include "config.php";
                                                        error_reporting(0);
                                                        $idtanah = $_GET['idtanah'];
                                                        $querysatu = mysql_query("SELECT luas,kepemilikan,lokasi FROM tanah where idtanah='$idtanah' ");
                                                        $bok = mysql_fetch_array($querysatu);
                                                    ?>
                                              <br>
                                              <input class="form-control" readonly="readonly" name="idtanah" placeholder="ID Tanah" type="text" value ="<?php echo $idtanah ?>">
                                              <br>
                                              <label >Luas</label>
                                              <br>
                                              <input class="form-control" placeholder="Meter Persegi" readonly="readonly" name="nama" type="text" value ="<?php echo $bok['luas'] ?>" >
                                              <br>
                                              <label >Kepemilikan Fakultas</label>
                                              <br>
                                              <input class="form-control" placeholder="Pilih Fakultas" readonly="readonly" name="kepemilikan" type="text" value ="<?php echo $bok['kepemilikan'] ?>" >
                                              <br>
                                              <label >Lokasi</label>
                                              <br>
                                              <input class="form-control" placeholder="Lokasi Tanah" readonly="readonly" name="keterangan" type="text" value ="<?php echo $bok['lokasi'] ?>" >
                                              <br>
                                              ...
                                              <br>
                                                <select class="form-control" name="mynewselect" >
                                                  ...
                                                  <option name="FIK" value="FIK" >FIK</option>
                                                  <option name="FIF" value="FIF" >FIF</option>
                                                  <option name="FRI" value="FRI" >FRI</option>
                                                  <option name="FEB" value="FEB" >FEB</option>
                                                  <option name="FKB" value="FKB" >FKB</option>
                                              </select>
                                              <br>
